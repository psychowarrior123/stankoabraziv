import { Button, Checkbox, FormControl, FormControlLabel, FormHelperText, Paper, PaperProps, Stack, TextField, Typography } from "@mui/material";
...
export const ContactUsForm: FC<PaperProps> = ({ sx, ...props }) => {
 ...
 return <Paper elevation={24} sx={{ p: 8, maxWidth: 540, ...sx }} {...props}>
  <Stack spacing={4}>
   <Stack spacing={2} alignItems="center" justifyContent="center">
    <Typography variant="H4">Узнать стоимость или заказать</Typography>
    <Typography variant="H6" textAlign="center">Для уточнения стоимости напишите Ваши имя, телефон, почту и интересующий Вас товар</Typography>
   </Stack>
   <Stack spacing={2}>
    <Controller
     name="name"
     ...
     render={({ field, fieldState }) => (
      <TextField
       ...
       helperText={!!fieldState.error && errors[fieldState.error.type as 'required' | 'min' | 'max' | 'minLength' | 'maxLength']}
       {...field}
      />
     )}
    />
