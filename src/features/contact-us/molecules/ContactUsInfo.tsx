...
export const ContactUsInfo: FC = () => {
  ...
  return (
    <Stack spacing={4} justifyContent="space-between" alignItems="center" height="100%" direction="column">
      <Item {...location.state.entity} sx={{ maxWidth: 540 }} />
      <Stack spacing={4} sx={{ maxWidth: 540 }} alignItems="center" justifyContent="center">
        ...
        <Typography variant="H5" textAlign="center">
          ...
          5-10 минут) или связаться с нами напрямую через номер телефона или почту! (достаточно просто нажать
          на картинку)
        </Typography>
        <Grid container>
          <Grid
